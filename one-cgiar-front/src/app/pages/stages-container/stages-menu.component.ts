...
export class StagesMenuComponent implements OnInit {
  ...
  constructor(public activatedRoute: ActivatedRoute, private cdRef: ChangeDetectorRef, public datepipe: DatePipe, public initiativesSvc: InitiativesService, public stageMenu: StagesMenuService, public _interactionsService: InteractionsService, public dialog: MatDialog, private router: Router, public _dataControlService: DataControlService, private _utilsService: UtilsService, public _pusherService: PusherService, public _authService: AuthService) {}
    ...
    this.activatedRoute.params.subscribe(resp => {
      ...
      forkJoin([promise1, promise2]).subscribe(
        val => {
          ...
          this.initiativesSvc.initiative.type = sucP1?.type;
  ...
  getInitiativeReadOnlyValidation(initiative) {
    this.initiativesSvc.getRolefromInitiativeById(this.initiativesSvc.initiative.id).subscribe(
      resp => {
