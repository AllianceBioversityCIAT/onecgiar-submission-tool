  ...
  it('POST initiatives/get-link/ Read citations data with token', async () => {
    await chai
      ...
      .then((res) => {
        ...
        expect(res.body)
          .to.have.property('title')
          .to.be.equal('Initiatives:Get link.');
        expect(res).to.be.a('object');
      });
  });
  ...
  it('PATCH initiatives/add-link/ Create citations', async () => {
    await chai
      ...
      .then((res) => {
        ...
        expect(res.body)
          .to.have.property('title')
          .to.be.equal('Initiatives:Add link.');
        expect(res).to.be.a('object');
      });
  });
  ...
  it('POST initiatives/get-budget/ Read budget data with token', async () => {
    await chai
      ...
      .then((res) => {
        ...
        expect(res.body)
          .to.have.property('title')
          .to.be.equal('Initiatives:Get budget.');
        expect(res).to.be.a('object');
      });
  });
  ...
  it('PATCH initiatives/add-budget/ Create Budget', async () => {
    await chai
      ...
      .then((res) => {
        ...
        expect(res.body)
          .to.have.property('title')
          .to.be.equal('Initiatives:Add Budget.');
        expect(res).to.be.a('object');
  ...
  it('GET initiatives/summary/ Request Initiative summary', async () => {
    await chai
      ...
      .then((res) => {
        ...
        expect(res.body)
          .to.have.property('title')
          .to.be.equal('Initiatives: Summary.');
        expect(res).to.be.a('object');
      });
  });
  ...
  it('GET initiatives/depth-description/ Request depth description ', async () => {
    await chai
      ...
      .then((res) => {
        ...
        expect(res.body)
          .to.have.property('title')
          .to.be.equal('Get Depth Description.');
        expect(res).to.be.a('object');
      });
  });
});
