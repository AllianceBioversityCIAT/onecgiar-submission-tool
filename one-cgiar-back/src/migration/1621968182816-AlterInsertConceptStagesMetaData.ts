...
export class AlterInsertConceptStagesMetaData1621968182816
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const concptStage = await stageRepo.findOne({
    ...
    const conceptEntitiesMeta = stageMetaRepo.create([
...

      {
        ...
        table_name: 'tocs',
        display_name:
          'Provide a narrative which explains further the TOC Diagram attached',
        stage_name: concptStage.description,
        active: true,
        visible: true,
        stage: concptStage
      ...
      },
      {
        ...
        table_name: 'work_packages',
        display_name:
          'Ensure both science/research and innovation/impact pathway content',
        stage_name: concptStage.description,
        active: true,
        visible: true,
        stage: concptStage
