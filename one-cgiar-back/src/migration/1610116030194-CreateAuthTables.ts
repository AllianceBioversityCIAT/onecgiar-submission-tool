...
export class CreateAuthTables1610116030194 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.createPrimaryKey('roles_by_users', [
      'role_id',
      'user_id'
    ]);
    await queryRunner.createIndices('roles_by_users', [
      new TableIndex({
    ...
    await queryRunner.createPrimaryKey('permissions_by_roles', [
      'permission_id',
      'role_id'
    ]);
    await queryRunner.createIndices('permissions_by_roles', [
      new TableIndex({
