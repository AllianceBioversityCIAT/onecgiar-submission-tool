    ...
    const rojectedProbabilitiesData = projectedProbabilitiesRepo.create([
      {
        ...
        description:
          '>80% expectation of achieving these impacts by 2030, at this point in the design process',
        active: true
      },
      {
        id: 2,
        name: 'High certainty',
        description:
          '60%-80% expectation of achieving these impacts by 2030, at this point',
        active: true
      },
      {
        id: 3,
        ...
        description:
          '40%-60% expectation of achieving these impacts by 2030, at this point',
        active: true
      },
      {
        id: 4,
        ...
        description:
          '<40% expectation of achieving these impacts by 2030, at this point',
        active: true
      }
    ]);
