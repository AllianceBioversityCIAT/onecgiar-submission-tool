...
export class CreateCountriesByMelia1653082324506 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `countries_by_melia_study` (`created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP, `id` int NOT NULL AUTO_INCREMENT, `active` tinyint NOT NULL, `meliaStudyId` int NOT NULL, `initvStgId` int NOT NULL, `country_id` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
